...
def lstm_uni(modell,real_valueser,start_index, end_index,forecast_horizon=24,window_size=24):
    from Model.funcs_lstm_single import TemperatureModel
    import numpy as np
    import torch
...
def multilstm_full(modell,data,start_idx,end_idx,forecast_horizon=24,window_size=24):
    from Model.funcs_lstm_multi import TemperatureModel_multi_full, TemperatureModel_multi_light
    import numpy as np
    import torch
...
def conv(modell,data,start_idx,end_idx):
    from funcs import TemperatureModel_conv, TemperatureModel_multi_light
    import numpy as np
    import torch
    from sklearn import preprocessing
    checkpoint_path = modell
