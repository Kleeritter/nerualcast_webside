...
tft_model_path = '../Model/output/tft/'+forecast_var+'.pth' # Replace with the actual path to your model
...
sommer=pd.DataFrame({
    ...
    'Temporal Fusion Transformer': list(itertools.chain(Messsomer[0:24], tft(tft_model_path, data_fuller,
                                                                                start_idx=start_index_test(nc_path,
                                                                                                           sommmertag,
                                                                                                           forecast_horizon=forecast_horizon,
                                                                                                           window_size=window_size),
                                                                                end_idx=end_index_test(nc_path,
                                                                                                       sommmertag,
                                                                                                       forecast_horizon=forecast_horizon,
                                                                                                       window_size=window_size),
                                                                                window_size=window_size))),
