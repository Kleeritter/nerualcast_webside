...
import xarray as xr
forecast_vars=["wind_dir_50",'temp',"press_sl","humid","globalrcm11","globalrcmp11","gust_10","gust_50", "rain", "wind_10", "wind_50"]
#forecast_var = 'temp'
window_sizes= [24,48,72,24*7,24*2*7,24*7*3,24*7*4]
#window_size= 24
