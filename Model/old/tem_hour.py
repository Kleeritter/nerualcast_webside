...
train_loader = DataLoader(train_data, batch_size=24, shuffle=False,num_workers=4)
val_loader = DataLoader(val_data, batch_size=24, shuffle=False,num_workers=4)

model = TemperatureModel()
trainer = pl.Trainer(max_epochs=1, accelerator="auto",devices="auto",val_check_interval=1.0) #log_every_n_steps=2,
