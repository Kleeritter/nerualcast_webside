...
class TemperatureModel(pl.LightningModule):
    def __init__(self, hidden_size=32, learning_rate=0.00005, weight_decay=0.0001, optimizer="Adam",dropout=0):
        super().__init__()
        ...
        self.lstm = torch.nn.LSTM(input_size=1, hidden_size=self.hidden_size, num_layers=1, batch_first=True,dropout=dropout)
